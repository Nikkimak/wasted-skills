...
- **Bootstrap/router**: nearest `AGENTS.md` or equivalent; intent
...
```text
project-root/
├── AGENTS.md or the project's established router
├── README.md or index
...
```text
project-root/
├── AGENTS.md            router: intent routes and constraints only
