...
- Put security controls into the design, while leaving final security readiness to the `feature-security-review` skill (invoked via the Skill tool as `/feature-security-review`) after task planning.
