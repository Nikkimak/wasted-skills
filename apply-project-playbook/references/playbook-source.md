...
This skill does not define the authoritative standard.

The canonical sources bundled with this skill are:

- `references/llm-friendly-project-structure-playbook.md`
- `references/project-agents-template.md`

Use this skill to apply those sources to real projects.
